...
public class BD {
   ...
   private static final Logger logger= Logger.getLogger(BD.class);
    private static final String SQL_DROP_CREATE_PACIENTES=" DROP TABLE IF EXISTS PACIENTES; " +
            ...
            "CEDULA VARCHAR(30) NOT NULL, FECHA_INGRESO DATE NOT NULL, EMAIL VARCHAR(50) NOT NULL, DOMICILIO_ID INT NOT NULL)";
    ...
    private static final String SQL_DROP_PRUEBA =
            "INSERT INTO DOMICILIOS (CALLE, NUMERO, LOCALIDAD, PROVINCIA) VALUES('Siempre Viva','748','Sprinfield','EUA'),('Calle Falsa','123','Sprinfield','EUA'); " +
                    "INSERT INTO PACIENTES (NOMBRE, APELLIDO, CEDULA, FECHA_INGRESO, EMAIL, DOMICILIO_ID) VALUES" +
                    "('Julian','Espinoza','234455667','2024-08-08','julian.espinoza@example.com',1)," +
                    "('Helen','Vasquez','3445666','2024-07-20','helen.vasquez@example.com',2); " +
                    "INSERT INTO ODONTOLOGOS(NUMERO_MATRICULA, NOMBRE, APELLIDO) VALUES('12345678FF','Helen','Vasquez'),('12852678LL','Mathias','Santos')";
